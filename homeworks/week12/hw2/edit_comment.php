		...
		$result_1 = $conn->query($sql_1); //確認通行證
			if($result_1->num_rows > 0) {
				...
				while($row = $result->fetch_assoc()) {
					echo '<div class="login_user">' . htmlspecialchars($row['username'], ENT_QUOTES, 'utf-8') . ' (' . htmlspecialchars($row['nickname'], ENT_QUOTES, 'utf-8') . ') <a href="./update.php">修改暱稱 </a> <a href="./index.php">回留言版</a> <a href="./admin.php">管理留言</a> <a href="./logout.php">登出</a></div>';
				} 
